...
Logger.prototype.query = function (options, callback) {
  ...
  function queryTransport(transport, next) {
    ...
    transport.query(options, function (err, results) {
      ...
      next(transport.formatResults(results, options.format));
    });
  }
  ...
  function addResults (transport, next) {
    queryTransport(transport, function (err, results) {
      results[transport.name] = err || results;
    });
  }
